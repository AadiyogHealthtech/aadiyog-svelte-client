...
<div class="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 overflow-x-hidden">
	<div data-testid={id} class={BASE_STYLES}>
		<div class="relative">
			<img class="w-44 h-44 rounded-lg object-cover" alt="CourseImage" {src} />
