<script lang="ts">
  ...
  <div class="h-screen w-full flex flex-col items-center justify-between px-8 py-8">
	...
	<div class="flex flex-col items-center justify-center">
	  ...
	  <div class="flex flex-col items-center bg-white rounded-lg py-2 sm:px-4 w-[90%] sm:w-[70%] max-w-[24rem] h-[4rem] relative overflow-hidden">
		<div class="w-[2px] bg-orange-500 absolute top-0 bottom-0 left-1/2 transform -translate-x-1/2"></div>
  
		<div bind:this={scrollContainer} class="flex items-center space-x-4 overflow-x-scroll pt-4 sm:pt-2 max-h-[6rem] w-full">
